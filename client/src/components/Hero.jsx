    ...
    return (
        <section className="home-hero relative mb-[20vh] min-h-[80vh] overflow-hidden pb-[10vh] pt-40 2xl:min-h-[90vh]">
            <div className="container">
                <div className="mx-auto w-4/5 text-center text-primary lg:mt-20 2xl:mt-0">
                    <h1 className=" mb-8 text-6xl font-medium uppercase leading-[1.4] md:text-[6vw] ">{data?.hero_title}</h1>
                    <p className=" text-lg font-thin md:text-2xl">{data?.hero_description}</p>
                </div>
            </div>
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 select-none text-center max-sm:hidden">
                <p className="hero-text whitespace-nowrap text-[20vmax] lowercase leading-none text-black/0 2xl:text-[16vmax]">{data?.hero_text_horizontal}</p>
            </div>
        </section>
    );
}
